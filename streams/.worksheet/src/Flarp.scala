...
object Flarp {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(119); 
   ...
   */
  val startPos: Pos;System.out.println("""startPos: => Flarp.Pos""");$skip(115); 
   ...
   */
  type Terrain = Pos => Boolean;System.out.println("""goal: => Flarp.Pos""");$skip(435); 
  ...
  case object Down  extends Move;System.out.println("""terrain: => Flarp.Pos => Boolean""");$skip(448); 
  ...
  def startBlock: Block = Block(startPos,startPos);System.out.println("""startBlock: => Flarp.Block""")}
