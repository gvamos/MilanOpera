...
val aTweets = GoogleVsApple.appleTweets;System.out.println("""aTweets  : objsets.TweetSet = """ + $show(aTweets ));$skip(73); val res$1 = 
 ...
 "this is a test of the emergency broadcasting system".contains("test");System.out.println("""res1: Boolean = """ + $show(res$1));$skip(66); val res$2 = 
                                                  
 Math.max(3,2);System.out.println("""res2: Int = """ + $show(res$2))}
